export default function IconButton({ icon: Icon, label, active = false, children, disabled = false, ...props }) {
  return (
    <button
      type="button"
      className={[
        'poster-button inline-flex h-10 min-w-10 items-center justify-center gap-2 rounded-sqd-xs border px-3 font-ui text-xs font-bold transition duration-200',
        active
