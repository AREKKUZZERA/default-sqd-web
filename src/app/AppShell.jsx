        ...
        groups: [
          {
            title: 'Профиль',
            items: [
              'Исправлено позиционирование online-бейджа на аватаре: индикатор больше не съезжает за границу и стабильно отображается поверх изображения.',
              'Размер бейджа теперь зависит от размера аватара, поэтому индикатор выглядит ровно в карточке профиля, шапке и уведомлениях.',
            ],
          },
        ],
      },
        ...
        groups: [
          {
            title: 'Интерфейс',
            items: [
              'Профиль, sidebar, карточки статистики и статусные select/pill приведены к более единому тёмному визуальному стилю.',
              'Улучшены фон, панели, границы, тени и presence-цвета для более современного и аккуратного вида.',
              'Доработана мобильная адаптация профиля: статусные действия, статистика и нижняя навигация лучше укладываются на узких экранах.',
            ],
          },
        ],
      },
